        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div>
                	...
                	<br><br><hr><br>
                	<h3 class="review-title">구매 상세 내역</h3>
                	<br><hr><br>	
	            ...
	            <form action="#">
					    ...
					    <tbody>
					        ...
					        <tr>
					            ...
					            <td class="td-content td-content-detail">
					            		날짜　:　<%=order.getRevDate() %><br>
					            		인원　:　5 명			            			            
					            </td>
					        </tr>
					        <tr>
					        	<td class="td-menu" >최종 결제 금액</td>
					            <td class="td-content">
					  ...
					  <br><br>
					  <div id="btnDiv">
					  	<input type="button" value="목록으로" id="backBtn" style="position: relative; left: 450px;" onclick="location.href='javascript:history.go(-1)'">
					  </div>
					  <br>					  
