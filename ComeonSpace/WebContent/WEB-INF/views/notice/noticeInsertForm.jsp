...
<body>
    ...
    <section class="container center">
       ...
       <div class="center-content center-align center-vertical">
       		<form action="<%= request.getContextPath()%>/insert.no" name="noInsertForm">
       			<br>
	       		<table class="question-table">
	       			<tr>
	       				<th>제목</th>
	       				<td><input type="text" name="title" size='30' placeholder="제목을 입력해주세요"></td>
	       			</tr>
	       			<tr>
	       				<th>공지 유형</th>
	       				<td>
	       			...
	       			<tr>
	       				<th>내용</th>
	       				<td>
	       					<textarea cols="60" rows="15" name="content" placeholder="내용을 입력해주세요"></textarea>
	       				</td>
	       			</tr>
	       			<tr>
	       				<th>사진 첨부</th>
	       			...
	       			<tr>
	       				...
	       				<td id="table-button">
							...
							<a href="ServiceCenter_mainView.html"><input type="button" class="btn btn-success text-white btn-block rounded-2 question-button" value="취소"></a>	       				
	       				</td>
	       			</tr>
	       		</table>
