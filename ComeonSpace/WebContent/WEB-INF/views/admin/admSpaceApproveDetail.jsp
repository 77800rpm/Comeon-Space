<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="java.util.ArrayList, product.model.vo.Product, img.model.vo.Img"%>
...
<body>
	...
	<div style="font-family: Sans-serif">
		...
		<div style="margin-left: 15%; margin-right: 50px; padding: 10%">
			...
			<br>
			<div class="tableArea" id="div-bg" style="padding:3%" align="center">
				<form
					action="<%=request.getContextPath()%>/admSpaceApproveDetailForm.bo" id="admFaqDetailForm" method="post">
					<table>
						<colgroup>
							<col width="100px">
							<col width="">
						...
						<tr>
							...
							<td>
								...
								<img src="<%=request.getContextPath()%>/img_upload/<%=productImgList.get(i).getImgChange()%>" style="width: 150px; height: 150px">
								<%	} %>
							</td>
						</tr>
					</table>
					...
					<div align="center">
						<a
							href="<%=request.getContextPath()%>/spaceApproveSuccess.bo?productNum=<%=product.getProductNum()%>"
							class="w3-button w3-teal">승인</a> <a
							href="<%=request.getContextPath()%>/spaceApproveDelete.bo?productNum=<%=product.getProductNum()%>"
							class="w3-button w3-red">삭제</a>
					</div>
				</form>
			</div>
			<hr id="about">
