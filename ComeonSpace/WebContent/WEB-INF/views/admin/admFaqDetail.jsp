			...
			<div>
				...
				<div class="tableArea">
					<form action="<%=request.getContextPath()%>/boardUpdateForm.bo"
						...
						<table>
							<tr>
								...
								<td colspan="3" class="testTh"><input type="text"
									name="title" value="<%=fo.getBoardFaqTitle()%>"></td>
								<td><input type="hidden" value="<%=fo.getBoardFaqNum()%>"
									name="fo"></td>
							</tr>
							<tr>
						...
						<br>
						<div align="center">
							<input type="button" id="faqDeleteBtn"
								class="btn btn-outline-secondary" onclick="faqDelete();"
								value="삭제">&nbsp; <input type="submit" id="faqUpdateBtn"
								class="btn btn-outline-secondary" value="수정">&nbsp; <input
